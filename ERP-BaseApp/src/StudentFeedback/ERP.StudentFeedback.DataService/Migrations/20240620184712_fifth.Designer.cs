...
namespace ERP.StudentFeedback.DataService.Migrations
{
    ...
    [Migration("20240620184712_fifth")]
    partial class fifth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ERP.StudentFeedback.Core.Entity.Feedback", b =>
                {
                    ...
                    b.Property<Guid?>("FeedbackResponsesLecturerId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("FeedbackResponsesModuleId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("FeedbackResponsesSemesterId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("FeedbackResponsesLecturerId", "FeedbackResponsesModuleId", "FeedbackResponsesSemesterId");

                    b.ToTable("Feedbacks");
                });

            modelBuilder.Entity("ERP.StudentFeedback.Core.Entity.FeedbackResponses", b =>
                {
                    b.Property<Guid>("LecturerId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("LecturerId", "ModuleId", "SemesterId");
            ...
            modelBuilder.Entity("ERP.StudentFeedback.Core.Entity.Feedback", b =>
                {
                    ...
                    b.HasOne("ERP.StudentFeedback.Core.Entity.FeedbackResponses", null)
                        .WithMany("Feedbacks")
                        .HasForeignKey("FeedbackResponsesLecturerId", "FeedbackResponsesModuleId", "FeedbackResponsesSemesterId");
